...
const MessagePage = () => {
  ...
  return (
    ...
    >
      <header className="top-0 h-14 bg-gradient-to-b from-white/70 to-transparent backdrop-blur-sm border-b border-gray-200 flex justify-between items-center px-4 relative z-50 shadow-lg">
